...
function getImageURLs($keyword, $orientation="horizontal") {
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "https://pixabay.com/api/?key=10280638-e6add6b8226faec7612300f53&q=$keyword&image_type=photo&orientation=$orientation&safesearch=true&per_page=100",
